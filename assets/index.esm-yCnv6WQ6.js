import{G as ul,_ as ll,H as cl,I as Lt,J as Zo,K as hl,L as fl,M as ta,N as dl,O as ml,P as gl,Q as Ot,S as pl,T as _l,U as yl,V as Tl,W as El,X as Ji,Y as Il}from"./index-Ds1eOCXr.js";var Zi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Me(r){if(r.code!==R.FAILED_PRECONDITION||r.message!==Ll)throw r;N("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es=-1;function ur(r){return r==null}function Wn(r){return r===0&&1/r==-1/0}function ql(r){return typeof r=="number"&&Number.isInteger(r)&&!Wn(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ha="";function jl(r){let t="";for(let e=0;e<r.length;e++)t.length>0&&(t=uo(t)),t=Bl(r.get(e),t);return uo(t)}function Bl(r,t){let e=t;const n=r.length;for(let i=0;i<n;i++){const o=r.charAt(i);switch(o){case"\0":e+="";break;case ha:e+="";break;default:e+=o}}return e}function uo(r){return r+ha+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mn{constructor(t,e="asc"){this.field=t,this.dir=e}}function Wl(r,t){return r.dir===t.dir&&r.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rs(r,t){if(r.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Wn(t)?"-0":t}}function xa(r){return{integerValue:""+r}}function dc(r,t){return ql(t)?xa(t):Rs(r,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kc{constructor(t){this.yt=t}}function Qc(r){const t=qc({parent:r.parent,structuredQuery:r.structuredQuery});return r.limitType==="LAST"?Jn(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{constructor(){this.changes=new me((t=>t.toString()),((t,e)=>t.isEqual(e))),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,gt.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return n!==void 0?V.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gr(r){return new Nc(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lo="PersistentStream";class ru{constructor(t,e,n,i,o,a,c,h){this.Mi=t,this.S_=n,this.b_=i,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=c,this.listener=h,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new nu(t,e)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,(()=>this.k_())))}q_(t){this.Q_(),this.stream.send(t)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,e){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,t!==4?this.M_.reset():e&&e.code===R.RESOURCE_EXHAUSTED?(Ft(e.toString()),Ft("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):e&&e.code===R.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.r_(e)}K_(){}auth(){this.state=1;const t=this.W_(this.D_),e=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([n,i])=>{this.D_===e&&this.G_(n,i)}),(n=>{t((()=>{const i=new D(R.UNKNOWN,"Fetching auth token failed: "+n.message);return this.z_(i)}))}))}G_(t,e){const n=this.W_(this.D_);this.stream=this.j_(t,e),this.stream.Xo((()=>{n((()=>this.listener.Xo()))})),this.stream.t_((()=>{n((()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,(()=>(this.O_()&&(this.state=3),Promise.resolve()))),this.listener.t_())))})),this.stream.r_((i=>{n((()=>this.z_(i)))})),this.stream.onMessage((i=>{n((()=>++this.F_==1?this.J_(i):this.onNext(i)))}))}N_(){this.state=5,this.M_.p_((async()=>{this.state=0,this.start()}))}z_(t){return N(Lo,`close with error: ${t}`),this.stream=null,this.close(4,t)}W_(t){return e=>{this.Mi.enqueueAndForget((()=>this.D_===t?e():(N(Lo,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Ch extends ru{constructor(t,e,n,i,o,a){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,i,a),this.serializer=o}j_(t,e){return this.connection.T_("Listen",t,e)}J_(t){return this.onNext(t)}onNext(t){this.M_.reset();const e=Mc(this.serializer,t),n=(function(o){if(!("targetChange"in o))return L.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?L.min():a.readTime?Nt(a.readTime):L.min()})(t);return this.listener.H_(e,n)}Y_(t){const e={};e.database=hs(this.serializer),e.addTarget=(function(o,a){let c;const h=a.target;if(c=os(h)?{documents:Fc(o,h)}:{query:Uc(o,h).ft},c.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){c.resumeToken=$a(o,a.resumeToken);const d=us(o,a.expectedCount);d!==null&&(c.expectedCount=d)}else if(a.snapshotVersion.compareTo(L.min())>0){c.readTime=er(o,a.snapshotVersion.toTimestamp());const d=us(o,a.expectedCount);d!==null&&(c.expectedCount=d)}return c})(this.serializer,t);const n=jc(this.serializer,t);n&&(e.labels=n),this.q_(e)}Z_(t){const e={};e.database=hs(this.serializer),e.removeTarget=t,this.q_(e)}}class Dh extends ru{constructor(t,e,n,i,o,a){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,i,a),this.serializer=o}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(t,e){return this.connection.T_("Write",t,e)}J_(t){return z(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,z(!t.writeResults||t.writeResults.length===0,55816),this.listener.ta()}onNext(t){z(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.M_.reset();const e=Lc(t.writeResults,t.commitTime),n=Nt(t.commitTime);return this.listener.na(n,e)}ra(){const t={};t.database=hs(this.serializer),this.q_(t)}ea(t){const e={streamToken:this.lastStreamToken,writes:t.map((n=>Oc(this.serializer,n)))};this.q_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const de="RemoteStore";class xh{constructor(t,e,n,i,o){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo((a=>{n.enqueueAndForget((async()=>{ge(this)&&(N(de,"Restarting streams for network reachability change."),await(async function(h){const d=F(h);d.Ea.add(4),await Tn(d),d.Ra.set("Unknown"),d.Ea.delete(4),await pr(d)})(this))}))})),this.Ra=new kh(n,i)}}async function pr(r){if(ge(r))for(const t of r.da)await t(!0)}async function Tn(r){for(const t of r.da)await t(!1)}function su(r,t){const e=F(r);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),Os(e)?Ms(e):Fe(e).O_()&&xs(e,t))}function ks(r,t){const e=F(r),n=Fe(e);e.Ia.delete(t),n.O_()&&iu(e,t),e.Ia.size===0&&(n.O_()?n.L_():ge(e)&&e.Ra.set("Unknown"))}function xs(r,t){if(r.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(L.min())>0){const e=r.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}Fe(r).Y_(t)}function iu(r,t){r.Va.Ue(t),Fe(r).Z_(t)}function Ms(r){r.Va=new Sc({getRemoteKeysForTarget:t=>r.remoteSyncer.getRemoteKeysForTarget(t),At:t=>r.Ia.get(t)||null,ht:()=>r.datastore.serializer.databaseId}),Fe(r).start(),r.Ra.ua()}function Os(r){return ge(r)&&!Fe(r).x_()&&r.Ia.size>0}function ge(r){return F(r).Ea.size===0}function ou(r){r.Va=void 0}async function Mh(r){r.Ra.set("Online")}async function Oh(r){r.Ia.forEach(((t,e)=>{xs(r,t)}))}async function Lh(r,t){ou(r),Os(r)?(r.Ra.ha(t),Ms(r)):r.Ra.set("Unknown")}async function Fh(r,t,e){if(r.Ra.set("Online"),t instanceof Ga&&t.state===2&&t.cause)try{await(async function(i,o){const a=o.cause;for(const c of o.targetIds)i.Ia.has(c)&&(await i.remoteSyncer.rejectListen(c,a),i.Ia.delete(c),i.Va.removeTarget(c))})(r,t)}catch(n){N(de,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await rr(r,n)}else if(t instanceof Kn?r.Va.Ze(t):t instanceof za?r.Va.st(t):r.Va.tt(t),!e.isEqual(L.min()))try{const n=await eu(r.localStore);e.compareTo(n)>=0&&await(function(o,a){const c=o.Va.Tt(a);return c.targetChanges.forEach(((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const g=o.Ia.get(d);g&&o.Ia.set(d,g.withResumeToken(h.resumeToken,a))}})),c.targetMismatches.forEach(((h,d)=>{const g=o.Ia.get(h);if(!g)return;o.Ia.set(h,g.withResumeToken(ht.EMPTY_BYTE_STRING,g.snapshotVersion)),iu(o,h);const I=new Kt(g.target,h,d,g.sequenceNumber);xs(o,I)})),o.remoteSyncer.applyRemoteEvent(c)})(r,e)}catch(n){N(de,"Failed to raise snapshot:",n),await rr(r,n)}}async function rr(r,t,e){if(!Oe(t))throw t;r.Ea.add(1),await Tn(r),r.Ra.set("Offline"),e||(e=()=>eu(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{N(de,"Retrying IndexedDB access"),await e(),r.Ea.delete(1),await pr(r)}))}function au(r,t){return t().catch((e=>rr(r,e,t)))}async function _r(r){const t=F(r),e=te(t);let n=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:Es;for(;Uh(t);)try{const i=await Eh(t.localStore,n);if(i===null){t.Ta.length===0&&e.L_();break}n=i.batchId,qh(t,i)}catch(i){await rr(t,i)}uu(t)&&lu(t)}function Uh(r){return ge(r)&&r.Ta.length<10}function qh(r,t){r.Ta.push(t);const e=te(r);e.O_()&&e.X_&&e.ea(t.mutations)}function uu(r){return ge(r)&&!te(r).x_()&&r.Ta.length>0}function lu(r){te(r).start()}async function jh(r){te(r).ra()}async function Bh(r){const t=te(r);for(const e of r.Ta)t.ea(e.mutations)}async function zh(r,t,e){const n=r.Ta.shift(),i=Vs.from(n,t,e);await au(r,(()=>r.remoteSyncer.applySuccessfulWrite(i))),await _r(r)}async function Gh(r,t){t&&te(r).X_&&await(async function(n,i){if((function(a){return Rc(a)&&a!==R.ABORTED})(i.code)){const o=n.Ta.shift();te(n).B_(),await au(n,(()=>n.remoteSyncer.rejectFailedWrite(o.batchId,i))),await _r(n)}})(r,t),uu(r)&&lu(r)}async function Fo(r,t){const e=F(r);e.asyncQueue.verifyOperationInProgress(),N(de,"RemoteStore received new credentials");const n=ge(e);e.Ea.add(3),await Tn(e),n&&e.Ra.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await pr(e)}async function $h(r,t){const e=F(r);t?(e.Ea.delete(2),await pr(e)):t||(e.Ea.add(2),await Tn(e),e.Ra.set("Unknown"))}function Fe(r){return r.ma||(r.ma=(function(e,n,i){const o=F(e);return o.sa(),new Ch(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)})(r.datastore,r.asyncQueue,{Xo:Mh.bind(null,r),t_:Oh.bind(null,r),r_:Lh.bind(null,r),H_:Fh.bind(null,r)}),r.da.push((async t=>{t?(r.ma.B_(),Os(r)?Ms(r):r.Ra.set("Unknown")):(await r.ma.stop(),ou(r))}))),r.ma}function te(r){return r.fa||(r.fa=(function(e,n,i){const o=F(e);return o.sa(),new Dh(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)})(r.datastore,r.asyncQueue,{Xo:()=>Promise.resolve(),t_:jh.bind(null,r),r_:Gh.bind(null,r),ta:Bh.bind(null,r),na:zh.bind(null,r)}),r.da.push((async t=>{t?(r.fa.B_(),await _r(r)):(await r.fa.stop(),r.Ta.length>0&&(N(de,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))}))),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cu{constructor(t){this.key=t}}class hu{constructor(t){this.key=t}}class Zh{constructor(t,e){this.query=t,this.Ya=e,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=j(),this.mutatedKeys=j(),this.eu=Da(t),this.tu=new Ae(this.eu)}get nu(){return this.Ya}ru(t,e){const n=e?e.iu:new Uo,i=e?e.tu:this.tu;let o=e?e.mutatedKeys:this.mutatedKeys,a=i,c=!1;const h=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,d=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(t.inorderTraversal(((g,I)=>{const P=i.get(g),S=hr(this.query,I)?I:null,x=!!P&&this.mutatedKeys.has(P.key),M=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let b=!1;P&&S?P.data.isEqual(S.data)?x!==M&&(n.track({type:3,doc:S}),b=!0):this.su(P,S)||(n.track({type:2,doc:S}),b=!0,(h&&this.eu(S,h)>0||d&&this.eu(S,d)<0)&&(c=!0)):!P&&S?(n.track({type:0,doc:S}),b=!0):P&&!S&&(n.track({type:1,doc:P}),b=!0,(h||d)&&(c=!0)),b&&(S?(a=a.add(S),o=M?o.add(g):o.delete(g)):(a=a.delete(g),o=o.delete(g)))})),this.query.limit!==null)for(;a.size>this.query.limit;){const g=this.query.limitType==="F"?a.last():a.first();a=a.delete(g.key),o=o.delete(g.key),n.track({type:1,doc:g})}return{tu:a,iu:n,Cs:c,mutatedKeys:o}}su(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,i){const o=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const a=t.iu.ya();a.sort(((g,I)=>(function(S,x){const M=b=>{switch(b){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return O(20277,{Rt:b})}};return M(S)-M(x)})(g.type,I.type)||this.eu(g.doc,I.doc))),this.ou(n),i=i??!1;const c=e&&!i?this._u():[],h=this.Xa.size===0&&this.current&&!i?1:0,d=h!==this.Za;return this.Za=h,a.length!==0||d?{snapshot:new ke(this.query,t.tu,o,a,t.mutatedKeys,h===0,d,!1,!!n&&n.resumeToken.approximateByteSize()>0),au:c}:{au:c}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Uo,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((e=>this.Ya=this.Ya.add(e))),t.modifiedDocuments.forEach((e=>{})),t.removedDocuments.forEach((e=>this.Ya=this.Ya.delete(e))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=j(),this.tu.forEach((n=>{this.uu(n.key)&&(this.Xa=this.Xa.add(n.key))}));const e=[];return t.forEach((n=>{this.Xa.has(n)||e.push(new hu(n))})),this.Xa.forEach((n=>{t.has(n)||e.push(new cu(n))})),e}cu(t){this.Ya=t.Qs,this.Xa=j();const e=this.ru(t.documents);return this.applyChanges(e,!0)}lu(){return ke.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const qs="SyncEngine";class tf{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class ef{constructor(t){this.key=t,this.hu=!1}}class nf{constructor(t,e,n,i,o,a){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=i,this.currentUser=o,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new me((c=>Ca(c)),cr),this.Iu=new Map,this.Eu=new Set,this.du=new Y(k.comparator),this.Au=new Map,this.Ru=new Cs,this.Vu={},this.mu=new Map,this.fu=Ne.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function rf(r,t,e=!0){const n=_u(r);let i;const o=n.Tu.get(t);return o?(n.sharedClientState.addLocalQueryTarget(o.targetId),i=o.view.lu()):i=await fu(n,t,e,!0),i}async function sf(r,t){const e=_u(r);await fu(e,t,!0,!1)}async function fu(r,t,e,n){const i=await Ih(r.localStore,Dt(t)),o=i.targetId,a=r.sharedClientState.addLocalQueryTarget(o,e);let c;return n&&(c=await of(r,t,o,a==="current",i.resumeToken)),r.isPrimaryClient&&e&&su(r.remoteStore,i),c}async function of(r,t,e,n,i){r.pu=(I,P,S)=>(async function(M,b,G,K){let Q=b.view.ru(G);Q.Cs&&(Q=await ko(M.localStore,b.query,!1).then((({documents:T})=>b.view.ru(T,Q))));const vt=K&&K.targetChanges.get(b.targetId),yt=K&&K.targetMismatches.get(b.targetId)!=null,ot=b.view.applyChanges(Q,M.isPrimaryClient,vt,yt);return zo(M,b.targetId,ot.au),ot.snapshot})(r,I,P,S);const o=await ko(r.localStore,t,!0),a=new Zh(t,o.Qs),c=a.ru(o.documents),h=yn.createSynthesizedTargetChangeForCurrentChange(e,n&&r.onlineState!=="Offline",i),d=a.applyChanges(c,r.isPrimaryClient,h);zo(r,e,d.au);const g=new tf(t,e,a);return r.Tu.set(t,g),r.Iu.has(e)?r.Iu.get(e).push(t):r.Iu.set(e,[t]),d.snapshot}async function af(r,t,e){const n=F(r),i=n.Tu.get(t),o=n.Iu.get(i.targetId);if(o.length>1)return n.Iu.set(i.targetId,o.filter((a=>!cr(a,t)))),void n.Tu.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(i.targetId),n.sharedClientState.isActiveQueryTarget(i.targetId)||await fs(n.localStore,i.targetId,!1).then((()=>{n.sharedClientState.clearQueryState(i.targetId),e&&ks(n.remoteStore,i.targetId),gs(n,i.targetId)})).catch(Me)):(gs(n,i.targetId),await fs(n.localStore,i.targetId,!0))}async function uf(r,t){const e=F(r),n=e.Tu.get(t),i=e.Iu.get(n.targetId);e.isPrimaryClient&&i.length===1&&(e.sharedClientState.removeLocalQueryTarget(n.targetId),ks(e.remoteStore,n.targetId))}async function lf(r,t,e){const n=pf(r);try{const i=await(function(a,c){const h=F(a),d=X.now(),g=c.reduce(((S,x)=>S.add(x.key)),j());let I,P;return h.persistence.runTransaction("Locally write mutations","readwrite",(S=>{let x=Ut(),M=j();return h.Ns.getEntries(S,g).next((b=>{x=b,x.forEach(((G,K)=>{K.isValidDocument()||(M=M.add(G))}))})).next((()=>h.localDocuments.getOverlayedDocuments(S,x))).next((b=>{I=b;const G=[];for(const K of c){const Q=Ec(K,I.get(K.key).overlayedDocument);Q!=null&&G.push(new re(K.key,Q,Ea(Q.value.mapValue),bt.exists(!0)))}return h.mutationQueue.addMutationBatch(S,d,G,c)})).next((b=>{P=b;const G=b.applyToLocalDocumentSet(I,M);return h.documentOverlayCache.saveOverlays(S,b.batchId,G)}))})).then((()=>({batchId:P.batchId,changes:Na(I)})))})(n.localStore,t);n.sharedClientState.addPendingMutation(i.batchId),(function(a,c,h){let d=a.Vu[a.currentUser.toKey()];d||(d=new Y(q)),d=d.insert(c,h),a.Vu[a.currentUser.toKey()]=d})(n,i.batchId,e),await En(n,i.changes),await _r(n.remoteStore)}catch(i){const o=Fs(i,"Failed to persist write");e.reject(o)}}async function du(r,t){const e=F(r);try{const n=await yh(e.localStore,t);t.targetChanges.forEach(((i,o)=>{const a=e.Au.get(o);a&&(z(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1,22616),i.addedDocuments.size>0?a.hu=!0:i.modifiedDocuments.size>0?z(a.hu,14607):i.removedDocuments.size>0&&(z(a.hu,42227),a.hu=!1))})),await En(e,n,t)}catch(n){await Me(n)}}function Bo(r,t,e){const n=F(r);if(n.isPrimaryClient&&e===0||!n.isPrimaryClient&&e===1){const i=[];n.Tu.forEach(((o,a)=>{const c=a.view.va(t);c.snapshot&&i.push(c.snapshot)})),(function(a,c){const h=F(a);h.onlineState=c;let d=!1;h.queries.forEach(((g,I)=>{for(const P of I.Sa)P.va(c)&&(d=!0)})),d&&Us(h)})(n.eventManager,t),i.length&&n.Pu.H_(i),n.onlineState=t,n.isPrimaryClient&&n.sharedClientState.setOnlineState(t)}}async function cf(r,t,e){const n=F(r);n.sharedClientState.updateQueryState(t,"rejected",e);const i=n.Au.get(t),o=i&&i.key;if(o){let a=new Y(k.comparator);a=a.insert(o,gt.newNoDocument(o,L.min()));const c=j().add(o),h=new mr(L.min(),new Map,new Y(q),a,c);await du(n,h),n.du=n.du.remove(o),n.Au.delete(t),js(n)}else await fs(n.localStore,t,!1).then((()=>gs(n,t,e))).catch(Me)}async function hf(r,t){const e=F(r),n=t.batch.batchId;try{const i=await _h(e.localStore,t);gu(e,n,null),mu(e,n),e.sharedClientState.updateMutationState(n,"acknowledged"),await En(e,i)}catch(i){await Me(i)}}async function ff(r,t,e){const n=F(r);try{const i=await(function(a,c){const h=F(a);return h.persistence.runTransaction("Reject batch","readwrite-primary",(d=>{let g;return h.mutationQueue.lookupMutationBatch(d,c).next((I=>(z(I!==null,37113),g=I.keys(),h.mutationQueue.removeMutationBatch(d,I)))).next((()=>h.mutationQueue.performConsistencyCheck(d))).next((()=>h.documentOverlayCache.removeOverlaysForBatchId(d,g,c))).next((()=>h.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,g))).next((()=>h.localDocuments.getDocuments(d,g)))}))})(n.localStore,t);gu(n,t,e),mu(n,t),n.sharedClientState.updateMutationState(t,"rejected",e),await En(n,i)}catch(i){await Me(i)}}function mu(r,t){(r.mu.get(t)||[]).forEach((e=>{e.resolve()})),r.mu.delete(t)}function gu(r,t,e){const n=F(r);let i=n.Vu[n.currentUser.toKey()];if(i){const o=i.get(t);o&&(e?o.reject(e):o.resolve(),i=i.remove(t)),n.Vu[n.currentUser.toKey()]=i}}function gs(r,t,e=null){r.sharedClientState.removeLocalQueryTarget(t);for(const n of r.Iu.get(t))r.Tu.delete(n),e&&r.Pu.yu(n,e);r.Iu.delete(t),r.isPrimaryClient&&r.Ru.jr(t).forEach((n=>{r.Ru.containsKey(n)||pu(r,n)}))}function pu(r,t){r.Eu.delete(t.path.canonicalString());const e=r.du.get(t);e!==null&&(ks(r.remoteStore,e),r.du=r.du.remove(t),r.Au.delete(e),js(r))}function zo(r,t,e){for(const n of e)n instanceof cu?(r.Ru.addReference(n.key,t),df(r,n)):n instanceof hu?(N(qs,"Document no longer in limbo: "+n.key),r.Ru.removeReference(n.key,t),r.Ru.containsKey(n.key)||pu(r,n.key)):O(19791,{wu:n})}function df(r,t){const e=t.key,n=e.path.canonicalString();r.du.get(e)||r.Eu.has(n)||(N(qs,"New document in limbo: "+e),r.Eu.add(n),js(r))}function js(r){for(;r.Eu.size>0&&r.du.size<r.maxConcurrentLimboResolutions;){const t=r.Eu.values().next().value;r.Eu.delete(t);const e=new k(W.fromString(t)),n=r.fu.next();r.Au.set(n,new ef(e)),r.du=r.du.insert(e,n),su(r.remoteStore,new Kt(Dt(Pa(e.path)),n,"TargetPurposeLimboResolution",ar.ce))}}async function En(r,t,e){const n=F(r),i=[],o=[],a=[];n.Tu.isEmpty()||(n.Tu.forEach(((c,h)=>{a.push(n.pu(h,t,e).then((d=>{if((d||e)&&n.isPrimaryClient){const g=d?!d.fromCache:e?.targetChanges.get(h.targetId)?.current;n.sharedClientState.updateQueryState(h.targetId,g?"current":"not-current")}if(d){i.push(d);const g=bs.As(h.targetId,d);o.push(g)}})))})),await Promise.all(a),n.Pu.H_(i),await(async function(h,d){const g=F(h);try{await g.persistence.runTransaction("notifyLocalViewChanges","readwrite",(I=>V.forEach(d,(P=>V.forEach(P.Es,(S=>g.persistence.referenceDelegate.addReference(I,P.targetId,S))).next((()=>V.forEach(P.ds,(S=>g.persistence.referenceDelegate.removeReference(I,P.targetId,S)))))))))}catch(I){if(!Oe(I))throw I;N(Ns,"Failed to update sequence numbers: "+I)}for(const I of d){const P=I.targetId;if(!I.fromCache){const S=g.Ms.get(P),x=S.snapshotVersion,M=S.withLastLimboFreeSnapshotVersion(x);g.Ms=g.Ms.insert(P,M)}}})(n.localStore,o))}async function mf(r,t){const e=F(r);if(!e.currentUser.isEqual(t)){N(qs,"User change. New user:",t.toKey());const n=await tu(e.localStore,t);e.currentUser=t,(function(o,a){o.mu.forEach((c=>{c.forEach((h=>{h.reject(new D(R.CANCELLED,a))}))})),o.mu.clear()})(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await En(e,n.Ls)}}function gf(r,t){const e=F(r),n=e.Au.get(t);if(n&&n.hu)return j().add(n.key);{let i=j();const o=e.Iu.get(t);if(!o)return i;for(const a of o){const c=e.Tu.get(a);i=i.unionWith(c.view.nu)}return i}}function _u(r){const t=F(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=du.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=gf.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=cf.bind(null,t),t.Pu.H_=Xh.bind(null,t.eventManager),t.Pu.yu=Yh.bind(null,t.eventManager),t}function pf(r){const t=F(r);return t.remoteStore.remoteSyncer.applySuccessfulWrite=hf.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=ff.bind(null,t),t}class sr{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=gr(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,e){return null}Mu(t,e){return null}vu(t){return ph(this.persistence,new dh,t.initialUser,this.serializer)}Cu(t){return new Za(Ds.mi,this.serializer)}Du(t){return new Ah}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}sr.provider={build:()=>new sr};class _f extends sr{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,e){z(this.persistence.referenceDelegate instanceof nr,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new Jc(n,t.asyncQueue,e)}Cu(t){const e=this.cacheSizeBytes!==void 0?Et.withCacheSize(this.cacheSizeBytes):Et.DEFAULT;return new Za((n=>nr.mi(n,e)),this.serializer)}}class ps{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>Bo(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=mf.bind(null,this.syncEngine),await $h(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new Qh})()}createDatastore(t){const e=gr(t.databaseInfo.databaseId),n=(function(o){return new Sh(o)})(t.databaseInfo);return(function(o,a,c,h){return new Nh(o,a,c,h)})(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return(function(n,i,o,a,c){return new xh(n,i,o,a,c)})(this.localStore,this.datastore,t.asyncQueue,(e=>Bo(this.syncEngine,e,0)),(function(){return Oo.v()?new Oo:new wh})())}createSyncEngine(t,e){return(function(i,o,a,c,h,d,g){const I=new nf(i,o,a,c,h,d);return g&&(I.gu=!0),I})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){await(async function(e){const n=F(e);N(de,"RemoteStore shutting down."),n.Ea.add(5),await Tn(n),n.Aa.shutdown(),n.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}ps.provider={build:()=>new ps};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yf{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ou(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ou(this.observer.error,t):Ft("Uncaught Error in snapshot listener:",t.toString()))}Nu(){this.muted=!0}Ou(t,e){setTimeout((()=>{this.muted||t(e)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+r.stack),t}class Tr extends yr{constructor(t,e,n,i){super(t,e,n,i),this.type="firestore",this._queue=new Ho,this._persistenceKey=i?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Ho(t),this._firestoreClient=void 0,await t}}}function $f(r,t){const e=ul(),n=Hn,i=ll(e,"firestore").getImmediate({identifier:n});if(!i._initialized){const o=cl("firestore");o&&wf(i,...o)}return i}function Iu(r){if(r._terminated)throw new D(R.FAILED_PRECONDITION,"The client has already been terminated.");return r._firestoreClient||Vf(r),r._firestoreClient}function Vf(r){const t=r._freezeSettings(),e=(function(i,o,a,c){return new Gl(i,o,a,c.host,c.ssl,c.experimentalForceLongPolling,c.experimentalAutoDetectLongPolling,Tu(c.experimentalLongPollingOptions),c.useFetchStreams,c.isUsingEmulator)})(r._databaseId,r._app?.options.appId||"",r._persistenceKey,t);r._componentsProvider||t.localCache?._offlineComponentProvider&&t.localCache?._onlineComponentProvider&&(r._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),r._firestoreClient=new Tf(r._authCredentials,r._appCheckCredentials,r._queue,e,r._componentsProvider&&(function(i){const o=i?._online.build();return{_offline:i?._offline.build(o),_online:o}})(r._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
