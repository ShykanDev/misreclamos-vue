import{d as Et,r as Ae,o as Tt,i as x,a as _,g as O,b as be,w as V,f,D as un,_ as vt,W as kt,X as dn,G as g,K as Ce,H as Ue,I as hn,J as fn,Q as m,Y as De,Z as pn,V as w,$ as mn,S as te,a0 as ne,M as Me,a1 as gn,a2 as _n,N as In,O as St,a3 as yn,a4 as wn,a5 as En,R as Ye,T as Xe,U as Qe,a6 as Tn,a7 as X,a8 as Q,a9 as vn,n as ae,s as S,aa as q,l as Ze,c as ce,ab as kn,p as Sn,F as et,j as Rn,ac as Pn,u as An,h as Y,t as bn,ad as Cn}from"./index-C-aO4PIL.js";const Nn={class:"flex w-full"},On={key:0,class:"text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-red-600 animate-delay-[50ms] animate__animated animate__zoomInLeft"},Ln={key:1,class:"text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-red-600 animate-delay-[50ms] animate__animated animate__zoomInLeft"},tt=Et({__name:"AnimatedLogo",setup(n){const e=Ae(!1),t=()=>{setInterval(()=>{e.value=!e.value},5e3)};return Tt(()=>{t()}),(r,s)=>{const i=be("v-icon"),o=be("router-link");return _(),x("div",Nn,[O(o,{to:"/",class:"inline-flex items-center"},{default:V(()=>[O(i,{name:"gi-megaphone",class:"text-rose-600 animate__animated animate__zoomInLeft",scale:"2"}),s[0]||(s[0]=f("span",{class:"text-xl font-bold text-rose-500 animate__animated animate__zoomInLeft"},"mis",-1)),e.value?(_(),x("span",On," reclamos ")):(_(),x("span",Ln," denuncias ")),(_(),x("span",{key:e.value,class:"text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800 animate-delay-[500ms] animate__animated animate__zoomInRight"}," .com "))]),_:1})])}}});function Rt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Un=Rt,Pt=new De("auth","Firebase",Rt());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class re{constructor(e,t){this.shortDelay=e,this.longDelay=t,b(t>e,"Short delay should be less than long delay!"),this.isMobile=gn()||_n()}get(){return xn()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wn=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Hn=new re(3e4,6e4);function T(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function y(n,e,t,r,s={}){return Ct(n,s,async()=>{let i={},o={};r&&(e==="GET"?o=r:i={body:JSON.stringify(r)});const a=ne({key:n.config.apiKey,...o}).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l={method:e,headers:c,...i};return En()||(l.referrerPolicy="no-referrer"),n.emulatorConfig&&Ue(n.emulatorConfig.host)&&(l.credentials="include"),bt.fetch()(await Nt(n,n.config.apiHost,t,a),l)})}async function Ct(n,e,t){n._canInitEmulator=!1;const r={...Vn,...e};try{const s=new $n(n),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw le(n,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const a=i.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw le(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw le(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw le(n,"user-disabled",o);const d=r[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw At(n,d,l);I(n,d)}}catch(s){if(s instanceof Me)throw s;I(n,"network-request-failed",{message:String(s)})}}async function se(n,e,t,r,s={}){const i=await y(n,e,t,r,s);return"mfaPendingCredential"in i&&I(n,"multi-factor-auth-required",{_serverResponse:i}),i}async function Nt(n,e,t,r){const s=`${e}${t}?${r}`,i=n,o=i.config.emulator?Fe(n.config,s):`${n.config.apiScheme}://${s}`;return Wn.includes(t)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}function qn(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class $n{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(v(this.auth,"network-request-failed")),Hn.get())})}}function le(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=v(n,e,r);return s.customData._tokenResponse=t,s}function rt(n){return n!==void 0&&n.enterprise!==void 0}class Kn{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const t of this.recaptchaEnforcementState)if(t.provider&&t.provider===e)return qn(t.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}isAnyProviderEnabled(){return this.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")||this.isProviderEnabled("PHONE_PROVIDER")}}async function jn(n,e){return y(n,"GET","/v2/recaptchaConfig",T(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it=new Map;function P(n){b(n instanceof Function,"Expected a class definition");let e=it.get(n);return e?(b(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,it.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rr(n,e={}){return y(n,"GET","/v2/passwordPolicy",T(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bt(n,e){return y(n,"POST","/v1/accounts:resetPassword",T(n,e))}async function wr(n,e){return y(n,"POST","/v1/accounts:signUp",e)}async function Er(n,e){return y(n,"POST","/v1/accounts:update",T(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tr(n,e){return se(n,"POST","/v1/accounts:signInWithPassword",T(n,e))}async function Gt(n,e){return y(n,"POST","/v1/accounts:sendOobCode",T(n,e))}async function vr(n,e){return Gt(n,e)}async function kr(n,e){return Gt(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sr(n,e){return se(n,"POST","/v1/accounts:signInWithEmailLink",T(n,e))}async function Rr(n,e){return se(n,"POST","/v1/accounts:signInWithEmailLink",T(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ar(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function br(n){const e=X(Q(n)).link,t=e?X(Q(e)).deep_link_id:null,r=X(Q(n)).deep_link_id;return(r?X(Q(r)).link:null)||r||t||e||n}class qe{constructor(e){const t=X(Q(e)),r=t.apiKey??null,s=t.oobCode??null,i=Ar(t.mode??null);u(r&&s&&i,"argument-error"),this.apiKey=r,this.operation=i,this.code=s,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=br(e);try{return new qe(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(n,e){return se(n,"POST","/v1/accounts:signUp",T(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yt(n,e,t=!1){if(w(n.app))return Promise.reject(A(n));const r="signIn",s=await Jt(n,r,e),i=await H._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Lr(n,e){return Yt(C(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return es;case"linkViaPopup":case"linkViaRedirect":return ns;case"reauthViaPopup":case"reauthViaRedirect":return ts;default:I(this.auth,"internal-error")}}resolve(e){b(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){b(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ts=new re(5e3,15e3),vs="__/auth/iframe",ks="emulator/auth/iframe",Ss={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Rs=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ps(n){const e=n.config;u(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Fe(e,ks):`https://${n.config.authDomain}/${vs}`,r={apiKey:e.apiKey,appName:n.name,v:te},s=Rs.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${ne(r).slice(1)}`}async function As(n){const e=await Es(n),t=k().gapi;return u(t,n,"internal-error"),e.open({where:document.body,url:Ps(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Ss,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=v(n,"network-request-failed"),a=k().setTimeout(()=>{i(o)},Ts.get());function c(){k().clearTimeout(a),s(r)}r.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bs={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Cs=500,Ns=600,Os="_blank",Ls="http://localhost";class gt{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Us(n,e,t,r=Cs,s=Ns){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const c={...bs,width:r.toString(),height:s.toString(),top:i,left:o},l=m().toLowerCase();t&&(a=Mt(l)?Os:t),Ut(l)&&(e=e||Ls,c.scrollbars="yes");const d=Object.entries(c).reduce((p,[F,J])=>`${p}${F}=${J},`,"");if(er(l)&&a!=="_self")return Ds(e||"",a),new gt(null);const h=window.open(e||"",a,d);u(h,n,"popup-blocked");try{h.focus()}catch{}return new gt(h)}function Ds(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
