<template>
  <MainLayout>
    <template #main>
      <LoaderA
        v-show="loading"
        class="flex fixed inset-0 z-40 justify-center items-center bg-rose-950/50"
      />
      <section
        class="flex justify-center items-center p-6 min-h-screen transition-all duration-300 bgStyle"
        :class="{ 'bg-black/25': isDark, 'bg-white/95': !isDark }"
      >
        <div
          @mouseenter="isDark = true"
        ...
        >
          ...
          >
            ...
            <span class="italic font-bold text-rose-700">{{ category }}</span>
          </h2>
          <!-- Subtítulo -->
          ...
          <form class="space-y-6" @submit.prevent="sendComplaint">
            ...
            <div class="space-y-2">
              <label
                for="title"
                class="block text-sm font-medium text-gray-700 transition-colors duration-200 hover:text-rose-600"
                >Título</label
              >
              <input
                type="text"
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <option
                  class="text-gray-200 group-hover:text-rose-600"
            ...
            <img
              ...
              :src="imageSelected"
              :key="imageSelected"
              class="rounded-3xl border-2 border-dashed animate-bounce animate-once w-sm border-slate-500"
            ...
            <button
              ...
              @click="removeImage"
              type="button"
              class="px-4 py-2 text-sm font-medium text-white bg-rose-600 rounded-lg transition-colors cursor-pointer w-sm hover:bg-rose-700"
            >
              Quitar imagen
            </button>
            <!-- Recordatorio -->
