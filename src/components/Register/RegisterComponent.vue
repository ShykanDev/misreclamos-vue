  ...
  <div class="flex justify-center items-start register">
    <div class="w-full">
      ...
      <div class="flex justify-center items-center p-4 min-h-screen">
        <div
          class="p-8 w-full bg-white rounded-3xl border border-pink-600 border-dotted shadow-2xl"
        >
          ...
          <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-gray-500 text-md">Unase y disfrute de todos los beneficios</p>
          </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <div>
              ...
              >
                *Su contraseña debe tener minimo 9 caracteres
              </p>
              <p
                class="text-gray-500 text-md"
                :class="{
                  ...
                  'text-green-500':
                    !passswordRequirements.uppercase && form.password.match(/[A-Z]/),
                }"
              >
              ...
              <p
                ...
                :class="{
                  ...
                  'text-green-500':
                    form.password === form.confirmPassword && form.password.length >= 9,
                }"
              >
              ...
              <p class="text-gray-500 text-md">
                ...
                <a href="#" class="text-rose-600">Términos y Condiciones</a>
              </p>
            </div>
