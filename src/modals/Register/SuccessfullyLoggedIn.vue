<template>
  <section
    class="flex fixed inset-0 z-50 justify-center items-center p-4 w-full backdrop-blur-sm bg-black/30 min-h-dvh"
  ...
  >
    ...
    >
      ...
      <!-- Título -->
      <h2 id="modal-title" class="mb-3 text-2xl font-bold text-gray-800">
      ...
      <p class="p-2 mb-6 leading-relaxed text-gray-600 bg-green-100 rounded-2xl">
        Como siguiente paso,
        <strong class="font-semibold text-green-600">verifique su correo</strong> haciendo clic en
        el enlace que le hemos enviado. Si no lo encuentra, revise su
        <strong class="font-semibold text-green-600">carpeta de spam</strong>.
      </p>
      <!-- Botón de acción -->
      <router-link
        to="/"
