...
.tv::after {
  ...
  border-radius: 15px;
  background:
    repeating-radial-gradient(#d1cecc 0 0.0001%, #00000070 0 0.0002%) 50% 0/2500px 2500px,
    repeating-conic-gradient(#e9e2dd 0 0.0001%, #00000070 0 0.0002%) 60% 60%/2500px 2500px;
  ...
  <div class="flex justify-center items-center bg-red-50 main_wrapper">
    <div class="main">
      ...
      <RouterLink
        ...
        class="px-4 py-2 mt-6 text-white bg-rose-800 rounded-md"
        >Crear nuevo comentario para {{ category }}</RouterLink
      >
      <div class="bottom">
        <div class="base1"></div>
        <div class="base2"></div>
