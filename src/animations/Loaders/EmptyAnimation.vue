...
<style scoped>
  ...
  .antenna_shadow {
    ...
    box-shadow:
      inset 0px 16px #a79d95,
      inset 0px 16px 1px 1px #9d9d9d;
    -moz-box-shadow:
      inset 0px 16px #fefdfb,
      inset 0px 16px 1px 1px #949494;
  }
  .antenna::after {
    content: "";
    position: absolute;
  ...
  .tv {
    ...
    box-shadow: inset 0.2em 0.2em #ffffff;
  }
  .tv::after {
    content: "";
    position: absolute;
    ...
    border-radius: 15px;
    background:
      repeating-radial-gradient(#d1cecc 0 0.0001%, #00000070 0 0.0002%) 50% 0/2500px
        2500px,
      repeating-conic-gradient(#e9e2dd 0 0.0001%, #00000070 0 0.0002%) 60% 60%/2500px
        2500px;
  ...
  .display_div {
    ...
    justify-content: center;
    border-radius: 15px;
    box-shadow: 3.5px 3.5px 0px #ada59b;
  }
  .screen_out {
    width: auto;
    height: auto;
...
<template>
  <div class="flex justify-center items-center bg-red-50 main_wrapper">
    <div class="main">
      <div class="antenna">
        ...
        <div class="display_div">
          <div class="screen_out">
            <div class="screen_out1">
              <div class="screen">
                <span class="notfound_text">No hay comentarios</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <RouterLink :to="{ name:'create-comment', params: { category: category } }" class="px-4 py-2 mt-6 text-white bg-rose-800 rounded-md">Crear nuevo comentario para {{ category }}</RouterLink>
      <div class="bottom">
        <div class="base1"></div>
        <div class="base2"></div>
        <div class="base3"></div>
      </div>
      <div class="text-black text_404">
        <span class="text_4041">No hay comentarios</span>
      </div>
    </div>
  </div>
</template>
